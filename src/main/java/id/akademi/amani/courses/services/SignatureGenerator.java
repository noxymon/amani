...
public class SignatureGenerator
{
    ...
    private String generateJwtToken()
    {
        ...
        Date jwtExpiredFromLocalDate = Date.from(
            jwtExpiredDate.atZone(ZoneId.systemDefault()).toInstant()
        );
    ...
    private ResponseEntity<MeetingDetailResponse> getMeetingDetailFromApi(String meetingNumber)
    {
        ...
        ResponseEntity<MeetingDetailResponse> meetingDetailResponseEntity = restTemplate.exchange(
    ...
    {
        try {
            ResponseEntity<MeetingDetailResponse> meetingDetailResponseEntity = getMeetingDetailFromApi(
                meetingNumber
            );
            return composeBasicSignatureOutput(
                meetingNumber,
                meetingDetailResponseEntity.getBody().getPassword()
            );
